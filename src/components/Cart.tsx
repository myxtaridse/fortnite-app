...
const Cart = () => {
  ...
  return (
    <div onClick={() => setModal(true)} className="mx-12 cursor-pointer">
      <div className="flex m-auto w-max items-center justify-center">
        <div className="w-7 shadow mx-1">
          <svg
        ...
        <p className="text-base text mx-[-4px] mt-[-8px]">
          {cart !== null && cart.length ? `+${cart.length}` : ""}
        </p>
      </div>
